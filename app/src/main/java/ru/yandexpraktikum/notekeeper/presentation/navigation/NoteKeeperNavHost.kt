    ...
    NavHost(
        ...
        composable(route = Screen.AllNotes.route) {
            ...
            DisposableEffect(Unit) {
                allNotesSubcomponent = appComponent.getAllNotesSubcomponent().create()
                onDispose {
        ...
        composable(route = Screen.AddNote.route) {
            ...
            DisposableEffect(Unit) {
                addNoteSubcomponent = appComponent.getAddNoteSubcomponent().create()
                onDispose {
